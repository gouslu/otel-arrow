...
impl local::Exporter<OtapPdata> for OTAPExporter {
    async fn start(
        ...
        _extension_registry: otap_df_engine::local::extension::ExtensionRegistry,
...
mod tests {
    ...
    fn test_receiver_not_ready_on_start() {
        ...
        async fn start_exporter(
            ...
            _ = exporter.start(pipeline_ctrl_msg_tx, metrics_reporter, otap_df_engine::local::extension::ExtensionRegistry::new()).await;
            Ok(())
        }
