...
/// # Thread Safety
///
/// This trait requires `Send + Sync`, making it compatible with the Arc-based
/// extension registry and any context that needs thread-safe access (e.g.,
/// tonic interceptors, shared state).
///
