...
/// Public alias so that `shared::extension::ExtensionRegistry` mirrors
/// `local::extension::ExtensionRegistry`.
...
pub trait SharedExtensionTrait: crate::extension::private::Sealed + Send + Sync {}
