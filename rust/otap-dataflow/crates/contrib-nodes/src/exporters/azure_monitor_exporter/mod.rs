...
pub static AZURE_MONITOR_EXPORTER: ExporterFactory<OtapPdata> = ExporterFactory {
    ...
    create: |pipeline_ctx: PipelineContext,
        ...
        // Resolve the bearer-token provider capability. The extension is
        // declared at the pipeline level and bound on this node via
        // `capabilities: { bearer_token_provider: <ext-name> }`.
        let token_provider = capabilities
            .require_local::<otap_df_engine::capability::bearer_token_provider::BearerTokenProvider>()
